...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_65_with_macro(
    ...
    KC_F3,   KC_F4,   CTL_T(KC_CAPS), KC_A,     KC_S,    KC_D,    KC_F,                KC_G,    KC_H,    KC_J,       KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,  KC_PGUP,
    KC_F5,   KC_F6,   KC_LSFT,        KC_Z,     KC_X,    KC_C,    KC_V,                KC_B,    KC_N,    KC_M,       KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,   KC_PGDN,
    KC_F7,   KC_F8,   KC_LCTL,        TG(_FN1), KC_LOPT, KC_LCMD, LT(_QUICK, KC_SPC),           _______, MO(_QUICK), KC_RCMD, KC_RCTL, _______, KC_LEFT, KC_DOWN, KC_RGHT
  ),

  [_QUICK] = LAYOUT_65_with_macro(
    ...
    _______, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, _______, _______, _______, KC_HOME,
...
3) [x] Alternative keybinds: swap ctrl with caps lock, etc.
4) Media control layer?
5) application specifc layers (vscode, fcx, logic, etc)
